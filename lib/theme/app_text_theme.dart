...
abstract final class AppTextTheme {
  ...
  static TextTheme get highContrastLight => _emphasize(light).apply(
        bodyColor: AppColors.hcPrimaryTextLight,
        displayColor: AppColors.hcPrimaryTextLight,
      );

  static TextTheme get highContrastDark => _emphasize(dark).apply(
        bodyColor: AppColors.hcPrimaryTextDark,
        displayColor: AppColors.hcPrimaryTextDark,
      );
